...
```{r allfit, cache=TRUE}
library(PSAT)
allfit <- mvnLinear(y, sigma, contrast = a, pval_threshold = pthreshold, test_direction = "two-sided",
...
```{r, getci}
cat("polyhedral naive: ", round(getPval(allfit, type = "naive"), 3), "\n")
cat("polyhedral pvalues: ", round(getPval(allfit, type = "polyhedral"), 3), "\n")
cat("polyhedral hybrid: ", round(getPval(allfit, type = "hybrid"), 3), "\n")
cat("polyhedral global-null: ", round(getPval(allfit, type = "global-null"), 3), "\n")
