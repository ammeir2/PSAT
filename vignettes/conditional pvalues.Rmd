...
```{r,eval = TRUE, fig.width=6, fig.align='center',echo=T}
  ...
  out.Fisher= aggregatePvalues(pmat1sided, globaltest = "Fisher", pv.threshold=0.001)
  print(out.Fisher)
...
```{r,eval = TRUE, fig.width=6, fig.align='center',echo=T}
  ...
  out.Fisher= aggregatePvalues(pmat2sided, globaltest = "Fisher", pv.threshold=0.001)
  print(out.Fisher)
...
```{r,eval = TRUE, fig.width=6, fig.align='center',echo=T}
  ...
  out.Pearson = aggregatePvalues(pmat1sided, globaltest = "Pearson", pv.threshold=0.001)
  print(out.Pearson)
